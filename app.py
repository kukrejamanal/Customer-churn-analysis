...
def main():
    ...
    if add_selectbox == "Online":
        ...
        DeviceProtection_No_internet_service = 'No'
        OnlineBackup_Yes = 'No'
        PaymentMethod_Credit_card__automatic_ = 'No'
        ...
        data = {
                ...
                'PaymentMethod_Credit_card__automatic_': PaymentMethod_Credit_card__automatic_
        }
        ...
        if uploaded_file is not None:
            ...
            if st.button('Predict'):
                ...
                prediction_df = prediction_df.replace({1:'Yes, the customer will terminate the service.',
                                                    0:'No, the customer is happy with our services.'})
                st.markdown("<h3></h3>", unsafe_allow_html=True)
